...
public class LoginTests {
    ...
    public void testSuccessfulLogin() {
        LoginData validUser = new LoginData( "gepid57587@besenica.com", "Asd@123456");
        ...
        given()
                ...
                .body("token", notNullValue()) // Ensure a token is returned
    ...
    public void testLoginWithWrongPassword() {
        LoginData invalidUser = new LoginData("gepid57587@besenica.com", "468676");
    ...
    public void testLoginWithInvalidUser() {
        LoginData ghostUser = new LoginData("gepid@besenica.com", "Asd@123456");
